...
export default function AttendanceView() {
    ...
    const todayRecord = attendanceList.find(a => new Date(a.date).toLocaleDateString() === todayStr);
    const isCheckedIn = !!todayRecord;
    const isCheckedOut = !!todayRecord?.checkOut;

    return (
        <div className="space-y-10 animate-in fade-in duration-500 w-full mx-auto">
